...
def generate_launch_description():
    ...
    preserve_controller_state_arg = DeclareLaunchArgument(
        'preserve_controller_state',
        default_value='false',
        choices=['true', 'false'],
        description='Verify already-enabled feedback without startup control writes; requires auto_enable=false. Speed is deferred until explicit arm motion.'
    )
    ...
    agx_arm_node = Node(
        ...
        parameters=[{
            ...
            'preserve_controller_state': LaunchConfiguration('preserve_controller_state'),
